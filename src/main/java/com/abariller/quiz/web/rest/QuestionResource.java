...
import com.abariller.quiz.service.dto.QuestionDTO;
...
/**
 * REST controller for managing {@link com.abariller.quiz.domain.Question}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class QuestionResource {
    ...
    public ResponseEntity<Question> partialUpdateQuestion(
        ...
        Optional<Question> result = questionRepository
            ...
            .map(
                existingQuestion -> {
                    if (question.getEntitled() != null) {
                        existingQuestion.setEntitled(question.getEntitled());
                    }
                    if (question.getSuggestions() != null) {
                        existingQuestion.setSuggestions(question.getSuggestions());
                    }
