package com.abariller.quiz.web.rest;
...
import com.abariller.quiz.IntegrationTest;
import com.abariller.quiz.domain.Question;
import com.abariller.quiz.repository.QuestionRepository;
...
class QuestionResourceIT {
    ...
    public static Question createEntity(EntityManager em) {
        Question question = new Question().entitled(DEFAULT_ENTITLED).suggestions(DEFAULT_SUGGESTIONS).answer(DEFAULT_ANSWER);
        return question;
    }
    ...
    public static Question createUpdatedEntity(EntityManager em) {
        Question question = new Question().entitled(UPDATED_ENTITLED).suggestions(UPDATED_SUGGESTIONS).answer(UPDATED_ANSWER);
        return question;
    }
    ...
    void createQuestion() throws Exception {
        ...
        assertThat(testQuestion.getEntitled()).isEqualTo(DEFAULT_ENTITLED);
        assertThat(testQuestion.getSuggestions()).isEqualTo(DEFAULT_SUGGESTIONS);
    ...
    @Test
    @Transactional
    void checkSuggestionsIsRequired() throws Exception {
        int databaseSizeBeforeTest = questionRepository.findAll().size();
        // set the field null
        question.setSuggestions(null);
    ...
    void putNewQuestion() throws Exception {
        ...
        updatedQuestion.entitled(UPDATED_ENTITLED).suggestions(UPDATED_SUGGESTIONS).answer(UPDATED_ANSWER);
        ...
        Question testQuestion = questionList.get(questionList.size() - 1);
        assertThat(testQuestion.getEntitled()).isEqualTo(UPDATED_ENTITLED);
        assertThat(testQuestion.getSuggestions()).isEqualTo(UPDATED_SUGGESTIONS);
    ...
    void partialUpdateQuestionWithPatch() throws Exception {
        ...
        partialUpdatedQuestion.suggestions(UPDATED_SUGGESTIONS);
    ...
    void fullUpdateQuestionWithPatch() throws Exception {
        ...
        partialUpdatedQuestion.entitled(UPDATED_ENTITLED).suggestions(UPDATED_SUGGESTIONS).answer(UPDATED_ANSWER);
